...
code_verifier: Optional[CodeGroundedVerifier] = None
model_mgr = None
...
async def _handle_chat_command(msg: str) -> str:
    ...
    if cmd == "/brain":
        ...
        if code_verifier:
            code_verifier.update_brain(brain)
...
async def chat(req: ChatRequest):
    ...
    try:
        ...
        if code_verifier and code_verifier.should_verify(msg, resp_text):
            resp_text = code_verifier.verify(resp_text, query=msg)
